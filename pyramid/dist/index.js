...
const hieroglyphs = require("./textures/hieroglyphs.png");
...
function init() {
  ...
  var map = textureLoader.load(hieroglyphs);
  ...
  var sandColor = textureLoader.load("dist/textures/sand-color.jpg");
  ...
  var colorMap = textureLoader.load("dist/textures/pyramid-color.jpg");
  var normalMap = textureLoader.load("dist/textures/pyramid-normal.jpg");
  var specMap = textureLoader.load("dist/textures/pyramid-spec.jpg");
  ...
  jsonLoader.load("dist/JSON/pyramidBase.json", function(geometry) {
  ...
  jsonLoader.load("dist/JSON/speakerBorders.json", function(geometry) {
  ...
  jsonLoader.load("dist/JSON/pyramidTop.json", function(geometry) {
  ...
  for (var i = 0; i < soundFiles.length; i++) {
    var sound = new Sound(["dist/sounds" + soundFiles[i] + ".mp3"]);
    sounds.push(sound);
  }
